# EyeCal
Code for the receptive fields' eye movement correction paper ***Subspace reverse-correlation estimation of receptive fields during free viewing*** to be published in the Journal of Vision. To use the code, 
