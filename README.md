# EyeCal
Code for the receptive fields' eye movement correction paper published in the Journal of Vision. To use the code, 
1. Download the data from the figshare repository [Subspace reverse-correlation estimation of receptive fields during free viewing](https://doi.org/10.6084/m9.figshare.32257377) and place it under ./data/ directory where the code is.
